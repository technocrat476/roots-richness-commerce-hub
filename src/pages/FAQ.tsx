...
const FAQ = () => {
  ...
  return (
    <div className="min-h-screen bg-white">
      <PageSEO
        title="FAQ - Wood-Pressed Oils Questions Answered | Roots & Richness"
        description="Get answers to common questions about wood-pressed oils, organic products, shipping, storage, health benefits, and more. Expert answers from India's premium natural oil brand."
        keywords="wood-pressed oil FAQ, cold-pressed oil questions, organic oil storage, natural oil benefits, oil pressing questions, traditional oil extraction, chemical-free oils"
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-lg text-neutral-medium max-w-3xl mx-auto mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6 max-w-4xl mx-auto">
            ...
            <div className="bg-gradient-to-br from-accent/10 to-accent/5 p-4 rounded-xl">
              <div className="text-2xl font-bold text-accent">12-18</div>
              <div className="text-sm text-neutral-medium">Months Shelf Life</div>
            </div>
            <div className="bg-gradient-to-br from-secondary/10 to-secondary/5 p-4 rounded-xl">
              <div className="text-2xl font-bold text-secondary">3-7</div>
              <div className="text-sm text-neutral-medium">Days Delivery</div>
            </div>
            <div className="bg-gradient-to-br from-green-500/10 to-green-500/5 p-4 rounded-xl">
              <div className="text-2xl font-bold text-green-600">7-Day</div>
              <div className="text-sm text-neutral-medium">Return Policy</div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-8 bg-neutral-light">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-xl font-semibold text-secondary mb-4">Browse by Category:</h2>
            <div className="flex flex-wrap gap-2">
              <Button variant="outline" size="sm" className="bg-primary text-white">All Questions</Button>
              ...
              {faqData.map((faq, index) => (
                <Card key={index} className="overflow-hidden hover:shadow-md transition-shadow">
                  <CardContent className="p-0">
                    ...
                    {openItems.includes(index) && (
                      <div className="px-6 pb-6 border-t border-neutral-light">
                        <p className="text-neutral-medium leading-relaxed pt-4">
                          {faq.answer}
                        </p>
                      </div>
                    )}
